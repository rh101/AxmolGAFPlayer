...
#define TEPLATE_CALLBACK_FUNCTION(__class__, __action__, __scene__) void __class__::__action__##Callback(ax::Object* sender) { \
    Scene *s = new (std::nothrow) __scene__(); \
    s->addChild(__action__##Action()); Director::getInstance()->replaceScene(s); s->release(); }

#define DEFAULT_ACTION_CALLBACKS(__scene__) void backCallback(ax::Object* sender); void nextCallback(ax::Object* sender); void restartCallback(ax::Object* sender);
